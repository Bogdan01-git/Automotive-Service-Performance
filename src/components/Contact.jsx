  ...
  return (
    <section id="contact" className="py-24 bg-background relative border-t border-surfaceAcc">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        {/* Google Map Embedded Block - Full Container Width */}
        <div className="mt-16 rounded-xl overflow-hidden h-64 sm:h-80 lg:h-[450px] shadow-xl border border-surfaceAcc">
          <iframe
            src="https://maps.google.com/maps?q=DIMA%20AUTOMOTIVE%20SHOP,%202379%20Hendersonville%20Rd,%20Arden,%20NC&t=&z=16&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="100%"
